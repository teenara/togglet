...
<!-- Sidebar ================================================== -->
	<div id="sidebar" class="span3">
		...
		<ul id="sideManu" class="nav nav-tabs nav-stacked">
			<li class="subMenu open"><a> ALL CATEGORY [230]</a>
				<ul>
				<?php foreach ($getAllCat as $getAllCat) {?>
													
				<li><a class="active" href="<?php echo base_url('product/searchProduct') ?>?cat_id=<?php echo $getAllCat->cat_id?>"><i class="icon-chevron-right"></i><?php echo $getAllCat->cat_name?> (100) </a></li>
				<?php }?>
				</ul>
			</li>

...
<!-- Sidebar end=============================================== -->
	...
	<div class="row">	  
            ...
            <a href="<?php echo base_url();?><?php echo $proDetails->product_image?>" title="Fujifilm FinePix S2950 Digital Camera">
				<img src="<?php echo base_url();?><?php echo $proDetails->product_image?>" style="width:100%" alt="Fujifilm FinePix S2950 Digital Camera"/>
            </a>
			<div id="differentview" class="moreOptopm carousel slide">
                <div class="carousel-inner">
                  <div class="item active">
                   <a href="<?php echo base_url();?><?php echo $proDetails->product_image?>"> <img style="width:29%" src="<?php echo base_url();?><?php echo $proDetails->product_image?>" alt=""/></a>
                   <a href="<?php echo base_url();?><?php echo $proDetails->product_image?>"> <img style="width:29%" src="<?php echo base_url();?><?php echo $proDetails->product_image?>" alt=""/></a>
                   <a href="<?php echo base_url();?><?php echo $proDetails->product_image?>" > <img style="width:29%" src="<?php echo base_url();?><?php echo $proDetails->product_image?>" alt=""/></a>
                  </div>
                  <div class="item">
			...
			<div class="span6">
				...
				<hr class="soft clr"/>
				<p>
				<?php echo $proDetails->product_desc?>
		...
		<div class="tab-content">
			<div class="tab-pane" id="listView">
				<div class="row">	  
					<div class="span2">
						<img src="<?php echo base_url();?><?php echo $proDetails->product_image?>" alt=""/>
					</div>
					<div class="span4">
						<h3>New | Available</h3>				
						<hr class="soft"/>
					...
					<form class="form-horizontal qtyFrm">
					<h3> $<?php echo $proDetails->product_price?></h3>
			...
			<div class="tab-pane active" id="blockView">
				<ul class="thumbnails">
					<li class="span3">
					  <div class="thumbnail">
						<a href="product_details.html"><img src="<?php echo base_url();?><?php echo $proDetails->product_image?>" alt=""/></a>
						<div class="caption">
